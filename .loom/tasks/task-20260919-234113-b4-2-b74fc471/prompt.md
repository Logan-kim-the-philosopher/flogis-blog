...
- Job ID: `job-20260919-234105-2026-09-20-b4-2-1f356c0b`
- Title: 2026-09-20 B4-2 평가 전사
- Goal: 바탕화면의 26-09-20_B4-2_평가 .m4a 전체를 가능한 정확하게 한국어로 전사하고 원본 기준 시각이 있는 단일 UTF-8 텍스트 파일을 같은 바탕화면에 저장한다.
- Status: `PENDING`
...
- Task ID: `task-20260919-234113-b4-2-b74fc471`
- Title: B4-2 평가 전체 전사본 저장
...
- Expected output: 바탕화면의 26-09-20_B4-2_평가_전사.txt 한 파일
